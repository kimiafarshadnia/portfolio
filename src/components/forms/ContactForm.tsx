    ...
    return (
        <form onSubmit={submitHandler} className="md:basis-2/4 w-full flex flex-col gap-6 pb-6">
            ...
            <div className="flex flex-col gap-2">
                ...
                <textarea rows={5} cols={4} name="message" id="message" onChange={changeHandler} className='bg-[#F2F2F2] dark:bg-[#2B2B2B] px-5 py-1 w-full rounded-lg placeholder:text-sm placeholder:text-[#BDBDBD]' placeholder="Enter Your Name here"></textarea>
            </div>
