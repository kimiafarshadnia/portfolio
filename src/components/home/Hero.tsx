...
export const Hero = () => {
    return (
        <div className="container mx-auto px-5 md:px-0 pt-[150px] flex justify-center">
            <div className='w-full absolute flex justify-center items-center top-[20rem]'>
            ...
            <div className="w-full flex flex-col md:flex-row-reverse gap-12 items-center justify-center md:justify-between text-center md:text-start z-10">
                ...
                <div className='flex flex-col gap-12'>
                    <h1 className="w-fit text-5xl sm:text-6xl md:text-7xl font-bold bg-lavender bg-clip-text text-transparent">Welcome to My World</h1>
